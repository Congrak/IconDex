...
export const LoginIcon = ({ height = 100, width = 120, color = '#000000' }: IconsProps) => {
  


  return <svg width={width} height={height} viewBox='0 0 21 21' fill='none' xmlns='http://www.w3.org/2000/svg'>
...
9.12813Z' fill={color} />
    ...
    <defs>
      <clipPath id='clip0_87_4636'>
        <rect width='20' height='20' fill={color} transform='translate(0.5 0.121582)' />
      </clipPath>
    </defs>
  </svg>;
};
