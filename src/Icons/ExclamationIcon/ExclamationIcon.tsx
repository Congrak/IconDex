...
export const ExclamationIcon = ({ height = 100, width = 100, color = '#000000', outline = false }: SwitchableProps) => {
  


  return outline ? (<svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 24 24" fill="none">
